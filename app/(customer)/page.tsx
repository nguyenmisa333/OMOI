      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
            <Image src="/images/omoi-logo.png" alt="O·MO·I" width={40} height={40} className="object-contain p-0.5" />
          </div>
          <div className="text-left">
            <p className="font-bold text-base">Chat auf WhatsApp</p>
            <p className="text-white/70 text-xs">App öffnen</p>
          </div>
        </div>
        <span className="material-symbols-outlined text-3xl flex-shrink-0">arrow_forward</span>
      </a>
